...
@section('tittle' , 'Create-language')
@section('style')
    ...
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body card-block">
                <form action="{{route('admin.lang.create')}}" method="post"  class="form-horizontal">
                    @csrf
                    <div class="row form-group">
                        <div class="col col-md-3"><label class=" form-control-label" for="name-input">Language name:</label></div>
                        <div class="col-12 col-md-9">
                            <input type="text" id="name-input" name="name" placeholder="language name" class="form-control">
                        </div>
                        @error('name')
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <input type="text" id="abbr-input" name="abbr" maxlength="10" placeholder="language abbr" class="form-control">
                        </div>
                        @error('abbr')
                        ...
                        <div class="col col-md-9">
                            <div class="form-check-inline form-check">
                                <label for="inline-radio1" class="form-check-label ">
                                    <input type="radio" id="inline-radio1" name="active" value="1" class="form-check-input">Active
                                </label>
                                <label for="inline-radio2" class="form-check-label ">
                                    <input type="radio" id="inline-radio2" name="active" value="0" class="form-check-input">Not Active
                                </label>
                            </div>
                        </div>
                        @error('active')
